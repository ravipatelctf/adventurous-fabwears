  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-6 pt-28 pb-24 md:pt-36 lg:pt-44">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <p className="mt-6 max-w-xl text-lg text-white/90">
                Premium sportswear and activewear fabrics engineered for stretch,
                durability, and long-term performance, trusted by global apparel brands.
              </p>
        ...
        <section className="mt-5 bg-background pb-16 md:pb-32">
