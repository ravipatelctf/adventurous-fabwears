...
export const products: Product[] = [
...

  {
    ...
    media: [
      ...
      { type: "video", src: "/videos/hero-video-2.mp4", alt: "placeholder video" }
    ],
...

  {
    ...
    media: [
      ...
      { type: "video", src: "/products/interlock-lycra/Polyester Interlock Fabrics ll Adventurous fabwears ludhaiana, punjab, India_1080p.mp4", alt: "Polyester Interlock Fabric" },
    ],
...

  {
    ...
    media: [
      ...
      { type: "video", src: "/products/jacquard-lycra/Jacquard Knitted Fabric l Adventurous Fabwears_1080p.mp4", alt: "jacquard-lycra-video1" },
    ],
...

  {
    ...
    media: [
      ...
      { type: "video", src: "/products/nylon-lycra/Nylon Lycra Fabric l Adventurous Fabwears manufacturer_1080p.mp4", alt: "Nylon Lycra Fabric video 1" },
    ],
...

  {
    ...
    media: [
      ...
      { type: "video", src: "/products/fleece-fabric/Cotton Fleece Fabric l Adventurous Fabwears_1080p.mp4", alt: "fleece fabric video 1" },
    ],
